...
const func = () => {}; //값
// const abc = if(true){}else{}; //값이 아니다 if는 문이다
...
// setTimeout(() => {
//   console.log(3);
// }, 2000); //데이터 알아서 받아올테니까 2초 동안 너네 할일 해
// console.log(4);
...
function getData(a, b, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show getData Funtion data");
      resolve({ a: a, b: b });
    }, 1000);
  });
}
...
function fromgetData(a, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show getData Funtion data :" + a);
      resolve(["a1", "b1", "c1"]);
    }, 1000);
  });
}

function getLastData(a, b, cb) {
  return new Promise((resolve, reject) => {
    setTimeout(() => {
      console.log("show getData Funtion data :" + a);
